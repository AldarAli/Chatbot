...
def article_info(html_file):
    ...
    # Extracting the authors of the article
    ...
    # Extracting the conference title of the article
    ...
    # Extracting the PDF URL of the article
